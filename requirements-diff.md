...
\n## Pip-installed packages (backend-pip-freeze.txt)
...
XlsxWriter==3.2.0
\n## Conda-exported packages (backend-conda-list.txt)
...
- uvicorn : MISSING
- sqlalchemy : MISSING
- pydantic : FOUND in conda
- python-jose[cryptography] : MISSING
- passlib[bcrypt] : MISSING
- Pillow : FOUND in pip
- pytesseract : MISSING
- pdfplumber : MISSING
- python-multipart : MISSING
- requests : FOUND in conda
- chromadb==0.5.5 : MISSING
- sentence-transformers==3.0.1 : MISSING
- numpy==1.26.4 : MISSING
- streamlit : MISSING
- plotly : MISSING
- pandas : MISSING
- python-dotenv : FOUND in conda
